...
public class HouseDTO {
  ...
  @Pattern(regexp="([A-Z])[\\s|A-Z|[0-9]|a-z|ñ|ó|í|á|é|ú|Á|Ó|É|Í|Ú]*$", message = "El nombre de la casa debe comenzar con mayúscula.")
  @Size(max = 50, message = "La longitud del nombre de la casa no puede superar los 50 caracteres.")
  private String name;

  @NotBlank(message = "El email debe estar cargado.")
